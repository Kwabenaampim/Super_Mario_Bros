    ...
    def draw(self):
        ...
        for i in range(0, 1025, 16): 
            ...
            if i in self.clouds.coordinates:
                pyxel.blt(i -self.player.decrease, self.clouds.y, constant.CLOUD_IMAGE[0], constant.CLOUD_IMAGE[1], constant.CLOUD_IMAGE[2], constant.CLOUD_IMAGE[3], constant.CLOUD_IMAGE[4])
            # Bushes
            if i in self.bushes.bush_coor:
                pyxel.blt(i-self.player.decrease, self.bushes.y, constant.BUSH_IMAGE[0], constant.BUSH_IMAGE[1], constant.BUSH_IMAGE[2], constant.BUSH_IMAGE[3], constant.BUSH_IMAGE[4])
            # Elements that interact with the player
            # Floor Blocks
            if i not in self.floor.not_blocks:
                pyxel.blt(i-self.player.decrease,self.floor.y, constant.FLOOR_IMAGE[0], constant.FLOOR_IMAGE[1], constant.FLOOR_IMAGE[2], constant.FLOOR_IMAGE[3], constant.FLOOR_IMAGE[4])
            # Breakable bricks
            if i in self.bb.bBBB:
                pyxel.blt(i-self.player.decrease, self.bb.y, constant.BRICK[0], constant.BRICK[1], constant.BRICK[2], constant.BRICK[3], constant.BRICK[4])
            # Question blocks at 'height' of 3 blocks
            if i in self.qb3.bQB3:
                pyxel.blt(i-self.player.decrease, self.qb3.y, constant.QUESTION_BLOCK_IMAGE[0], constant.QUESTION_BLOCK_IMAGE[1], constant.QUESTION_BLOCK_IMAGE[2], constant.QUESTION_BLOCK_IMAGE[3], constant.QUESTION_BLOCK_IMAGE[4])
            # Question blocks at 'height' of 6 blocks
            if i in self.qb6.bQB6:
                pyxel.blt(i-self.player.decrease, self.qb6.y, constant.QUESTION_BLOCK_IMAGE[0], constant.QUESTION_BLOCK_IMAGE[1], constant.QUESTION_BLOCK_IMAGE[2], constant.QUESTION_BLOCK_IMAGE[3], constant.QUESTION_BLOCK_IMAGE[4])
            # Conditional that draws pipes
            if i in self.pipes.pipes_list:
                # The 'single' hegiht pipe
                if i == self.pipes.pipes_list[0]:
                    pyxel.blt(i-self.player.decrease, self.pipes.y+16, constant.PIPE_IMAGE[0], constant.PIPE_IMAGE[1], constant.PIPE_IMAGE[2], constant.PIPE_IMAGE[3], constant.PIPE_IMAGE[4])
                ...
                if i == self.pipes.pipes_list[1]:
                    ...
                    for o in range(0,2):
                        pyxel.blt(i-self.player.decrease, self.pipes.y+(16-(o*16)), constant.PIPE_IMAGE[0], constant.PIPE_IMAGE[1], constant.PIPE_IMAGE[2], constant.PIPE_IMAGE[3], constant.PIPE_IMAGE[4])
        ...
        #    x = randint(0,3)
        #    if x in range(0,3):
                pyxel.blt(self.goomba.goomba_x-self.player.decrease ,  self.goomba.goomba_y, constant.GOOMBA_IMAGE[0] , constant.GOOMBA_IMAGE[1], constant.GOOMBA_IMAGE[2], constant.GOOMBA_IMAGE[3], constant.GOOMBA_IMAGE[4])
        #        self.enemies += 1
        #    elif x == 3:
                pyxel.blt(self.koopa.koopa_x - self.player.decrease , self.koopa.koopa_y, constant.KOOPA_TROOPA_IMAGE[0] , constant.KOOPA_TROOPA_IMAGE[1], constant.KOOPA_TROOPA_IMAGE[2], constant.KOOPA_TROOPA_IMAGE[3], constant.KOOPA_TROOPA_IMAGE[4])
        #        self.enemies += 1
        # Player drawing sprite and movement    
        pyxel.blt(self.player.x, self.player.y, 0, constant.MARIO_IMAGE[0], constant.MARIO_IMAGE[2], constant.MARIO_IMAGE[3], constant.MARIO_IMAGE[4], 12)
